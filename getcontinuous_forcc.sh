...
cont_outputdir=/disk/staff/jwalter/southeastAK/run_ca/ContWaveform
template_outputdir=/disk/staff/jwalter/southeastAK/run_ca/TempWaveform
dbname=/disk/staff/jwalter/southeastAK/seak
...
sacarrivaltime_fromcont_v2_can.pl $dbname $cont_outputdir $template_outputdir $netcode $minassoc
