...
year1=2013
year2=2015
datadir=/disk/staff/jwalter/tamnet
cont_outputdir=/disk/staff/jwalter/tamnet/ContWaveform
#template_outputdir=/disk/staff/jwalter/lajitas/TempWaveform
#work_directory=/disk/cg7/jwalter/lajitas/working
dbname=/disk/staff/jwalter/tamnet/database2015/tamnet
...
tosac_from_msd_db2sac_tamnet.pl $day1 $day2 $yeari $datadir $cont_outputdir $dbname $netcode
