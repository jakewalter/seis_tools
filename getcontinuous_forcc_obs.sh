...
year1=2013
year2=2013
datadir=/disk/staff/sean/alaska/obs_craig_rapid/day_volumes
cont_outputdir=/disk/cg7/jwalter/obs/ContWaveform
template_outputdir=/disk/cg7/jwalter/obs/TempWaveform
work_directory=/disk/cg7/jwalter/obs/WorkDir
dbname=/disk/staff/sean/alaska/obs_craig_rapid/QCFdb2/craig2
...
tosac_from_msd_db2sac_obs.pl $day1 $day2 $yeari $datadir $cont_outputdir $dbname $netcode
tosac_from_msd_db2sac_obs2.pl $day1 $day2 $yeari $datadir $cont_outputdir $dbname $netcode
...
sacarrivaltime_fromcont_v2_obs.pl $dbname $cont_outputdir $template_outputdir $netcode $minassoc
