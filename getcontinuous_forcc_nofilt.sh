...
year1=2015
year2=2015
datadir=/disk/staff/jwalter/dallas/day_volumes
#cont_outputdir=/disk/staff/jwalter/southeastAK/ContWaveform
cont_outputdir=/disk/cg5/jwalter/dallas/ContWaveform_nofilt
#template_outputdir=/disk/cg5/jwalter/run_ca/TempWaveform
#template_outputdir=/disk/staff/jwalter/southeastAK/TempWaveform
#contdb=/disk/staff/cg5/southeastAK/AECdata/AECdata
dbname=/disk/staff/jwalter/dallas/dallas
...
echo $yeari
#### Make Continous waveforms  % check for 2012 compatibility
tosac_from_msd_db2sac_nofilt.pl $day1 $day2 $yeari $datadir $cont_outputdir $dbname $netcode
