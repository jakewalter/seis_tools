...
@dbo = dbsubset(@dbo, "origin.lat < 34");
@dbo = dbsubset(@dbo, "origin.lat > 29");
@dbo = dbsubset(@dbo, "origin.lon < -91");
@dbo = dbsubset(@dbo, "origin.lon > -95");
#@dbo = dbsubset(@dbo, "origin.lat >= 45 ");
#@dbo = dbsubset(@dbo, "origin.lon >= -106.5 ");
@dbe = @dbo;
