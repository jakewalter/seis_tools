...
year1=2009
year2=2015
datadir=/disk/staff/jwalter/solomons/day_volumes
cont_outputdir=/disk/cg7/jwalter/solomon/ContWaveform_nofilt
template_outputdir=/disk/cg7/jwalter/solomon/TempWaveform
work_directory=/disk/cg7/jwalter/solomon/WorkDir
dbname=/disk/staff/jwalter/solomons/solomon
...
tosac_from_msd_db2sac_solomon.pl $day1 $day2 $yeari $datadir $cont_outputdir $dbname $netcode
