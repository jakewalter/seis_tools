...
year1=2002
year2=2015
datadir=/disk/cg5/jwalter/dallas/longercross/day_volumes
cont_outputdir=/disk/cg5/jwalter/dallas/longercross/ContWaveform
template_outputdir=/disk/cg5/jwalter/dallas/longercross/TempWaveform2
work_directory=/disk/cg5/jwalter/dallas/longercross/WorkDir
dbname=/disk/cg5/jwalter/dallas/longercross/dallaslong
...
tosac_from_msd_db2sac_venus.pl $day1 $day2 $yeari $datadir $cont_outputdir $dbname $netcode
...
#sacarrivaltime_fromcont_v2_dallas.pl $dbname $cont_outputdir $template_outputdir $netcode $minassoc
