...
year1=2013
year2=2013
datadir=/disk/staff/jwalter/southeastAK/day_volumes
#cont_outputdir=/disk/staff/jwalter/southeastAK/ContWaveform
cont_outputdir=/disk/cg5/jwalter/southeastAK/CNSNdata/ContWaveform_nofilt
template_outputdir=/disk/cg5/jwalter/southeastAK/CNSNdata/TempWaveform_nofilt
#template_outputdir=/disk/staff/jwalter/southeastAK/TempWaveform
#contdb=/disk/staff/cg5/southeastAK/AECdata/AECdata
dbname=/disk/staff/jwalter/southeastAK/HG_oct_mar
#dbname2=/disk/cg5/jwalter/southeastAK/AECdata/dbAEC_JanApr2013
netcode=YY
minassoc=4
...
echo $yeari
#### Make Continous waveforms  % check for 2012 compatibility
tosac_from_msd_db2sac_nofilt2.pl $day1 $day2 $yeari $datadir $cont_outputdir $dbname $netcode
