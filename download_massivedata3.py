...
endtime = UTCDateTime("2016-02-01T00:00:00.000")
...
restrictions = Restrictions(starttime=starttime, endtime=endtime,chunklength_in_sec=86400,reject_channels_with_gaps=False,minimum_length=0,minimum_interstation_distance_in_m=100, channel_priorities=["HH[NE12Z]","BH[NE12Z]"],location_priorities=["", "00", "10"])

mdl = MassDownloader()
mdl.download(domain, restrictions, threads_per_client=3, mseed_storage="/data/antarctica/waveforms",stationxml_storage="/data/antarctica/stations")
