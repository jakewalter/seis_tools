...
starttime = UTCDateTime("2017-12-01T00:00:00.000")
...
domain = CircularDomain(35.5,-98.5,minradius=0.0, maxradius=3.0)
...
mdl = MassDownloader()
mdl.download(domain, restrictions, threads_per_client=3, mseed_storage="/data/scoop/waveforms",stationxml_storage="/data/scoop/stations")
